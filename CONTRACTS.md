...
| `port_18080` | critical | 33 | src/bundle/App-BX6o9fW5_components/Tr.jsx(1) · src/bundle/endpointConfig-Bt85xi8d.js(5) · localTool/src/db/database.ts(2) · localTool/src/index.ts(5) · localTool/src/routes/files.ts(1) · localTool/src/routes/official.ts(13) · localTool/src/routes/passthrough.ts(2) · localTool/src/routes/resources.ts(1) · localTool/src/routes/system.ts(1) · public/background.js(2) |
| `port_9004` | critical | 1 | localTool/src/utils/netProxy.ts(1) |
| `api_proxy_path` | critical | 10 | src/bundle/httpClient-BknZwXjG_components/shared.js(4) · localTool/src/index.ts(3) · localTool/src/routes/official.ts(1) · localTool/src/routes/system.ts(1) · localTool/src/utils/netProxy.ts(1) |
...
| `envelope_code_data` | critical | 4 | src/bundle/App-BX6o9fW5_components/Vr.jsx(1) · src/bundle/App-BX6o9fW5_components/shared.js(1) · localTool/src/routes/system.ts(2) |
| `kv_canvas_state_v1` | medium | 4 | src/bundle/App-BX6o9fW5_components/Vr.jsx(2) · src/bundle/httpClient-BknZwXjG_components/shared.js(2) |
| `kv_active_api_endpoint` | medium | 7 | src/bundle/endpointConfig-Bt85xi8d.js(1) · localTool/src/routes/official.ts(5) · localTool/src/routes/passthrough.ts(1) |
