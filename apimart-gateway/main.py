...
# ============================================================================
# 路由别名：兼容画布 discountVideo 节点使用的 /v1/gateway/* 统一前缀
# 前端统一走 /v1/gateway/*，真实端点映射由本区块集中维护；未来端点调整只改这里。
# (2026-07-28)
# ============================================================================
...
async def gateway_generate(request: Request):
    return await _submit_generation(request, "VIDEO")


@app.get("/v1/gateway/task/{task_id}")
async def gateway_task(task_id: str, request: Request):
